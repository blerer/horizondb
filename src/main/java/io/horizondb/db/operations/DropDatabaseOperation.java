...
/**
 */
final class DropDatabaseOperation implements Operation {
    ...
    public Object perform(OperationContext context, Msg<?> request) throws IOException, HorizonDBException {
        ...
        DropDatabasePayload payload = Msgs.getPayload(request);

        DatabaseManager manager = context.getDatabaseManager();
        manager.dropDatabase(payload.getDatabase(), true);
